...
if [[ $ISLARGEIMAGE -eq 1 ]];
  then
    RIGIDCONVERGENCE="[ 1000x500x500x250x100,1e-6,10 ]"
    RIGIDSHRINKFACTORS="12x8x4x2x1"
    RIGIDSMOOTHINGSIGMAS="5x4x3x2x1vox"

    AFFINECONVERGENCE="[ 1000x500x500x250x100,1e-6,10 ]"
    AFFINESHRINKFACTORS="12x8x4x2x1"
    AFFINESMOOTHINGSIGMAS="5x4x3x2x1vox"

    SYNCONVERGENCE="[ 1000x500x300x200x250x200,1e-6,10 ]"
    SYNSHRINKFACTORS="32x16x8x4x2x1"
    SYNSMOOTHINGSIGMAS="6x5x4x3x2x1vox"

    # SYNCONVERGENCE="[ 400x300x200x180x150,1e-6,10 ]"
    # SYNSHRINKFACTORS="16x8x4x2x1"
